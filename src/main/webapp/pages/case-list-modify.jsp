...
<%--                            </security:authorize>--%>
    ...
    <script type="text/javascript">
        <%--$(function () {--%>
        <%--    var pageCount=50;--%>
        <%--    $("#itbody").pagination(pageCount,{--%>
        <%--        callback:function(page_index){--%>
        <%--            $.ajax({--%>
        <%--                type:"post",--%>
        <%--                dataType:"json",--%>
        <%--                url:"/case/findAllCase",--%>
        <%--                success:function (data) {--%>
        <%--                    var showNum = 5;--%>
        <%--                    var dataL = data.result.length;--%>
        <%--                    var page_index = Math.ceil(dataL / showNum);--%>
        <%--                    console.log(page_index)--%>
        <%--                    console.log(data.result)--%>
        <%--                    for (var i = 0; i < data.result.length; i++){--%>
        <%--                        var $tr=$("<tr>"+"</tr>");--%>
        <%--                        &lt;%&ndash;var baseURI="${pageContext.request.contextPath}/case/findCaseById?caseid="&ndash;%&gt;--%>
        ...
        <%--                $("#itbody").pagination(pageNum,{--%>
        <%--                    prev_text: "上一页",--%>
        <%--                    next_text: "下一页",--%>
        <%--                    num_edge_entries: 1, //边缘页数--%>
        <%--                    num_display_entries: 4, //主体页数--%>
        <%--                    items_per_page: showNum, //每页显示1项--%>
